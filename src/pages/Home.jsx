    ...
    return (
        <div className="min-h-screen bg-[#090a09] text-white">
            ...
            <main className="mx-auto flex flex-col gap-10 max-w-[1280px] px-6 pb-24">
                ...
                <section className="relative  overflow-hidden rounded-[24px] border border-[#888] px-12 py-14">
                    ...
                    <div className="relative flex flex-col gap-5 z-10">
                        ...
                        <h2 className="text-5xl font-bold leading-[1.05]">
                            Welcome back,
                            <br />
                            <span className="text-[#c6ff00]">Pratyush!</span>
                        </h2>
                    ...
                    <div className="absolute right-12 top-1/2 flex -translate-y-1/2 flex-col gap-3">
                        <div className="w-40 rounded-2xl border border-[#3d5100] bg-[#1d2905] px-5 py-6 text-center">
                        ...
                        <div className="w-40 rounded-2xl border border-[#888] px-5 py-5 text-center">
                ...
                <ProductShowcase topRated={topRated} newArrivals={arrivals}/>
...
const StatCard = ({
    ...
    return (
        <div className="flex items-center gap-4 rounded-[22px] border border-[#888] p-6">
            <div
...
const FeatureCard = ({ icon, title, subtitle }) => {
    return (
        <div className="flex items-center gap-4 rounded-2xl border border-[#888] px-6 py-5">
